...
/******************NEW!!!!!!!!!!!!********************
新增长数据接收功能，可通过串口接收长数据
通过宏USMART_ENABLE_DATA_RCV配置，定义在usmart_config.h文件中
*****************************************************/
#ifndef __USMART_H
#define __USMART_H
...
/***********************For data rcv function********************************/
#define USMART_BUFF_OVERFLOW 5   // 缓冲区溢出
#define USMART_DATA_RCV_ERROR 6  // 数据接收错误
...
struct _m_usmart_dev {
    uint8_t mode_flag;                 // 当前模式标志,0:指令模式；1:数据接收模式；后续可自由拓展模式
